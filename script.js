...
function startFlashing() {
  if (intervalId === null) { // added so the flashing cannot be sped up and double click is registered
    intervalId = setInterval(() => { // will be ran only if flashing is stopped
